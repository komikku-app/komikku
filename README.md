...
The `build_preview.yml` workflow in this fork signs the preview APKs during the Gradle build.
...
The same values can also be passed locally with Gradle properties or environment variables if you want to generate signed preview APKs outside GitHub Actions.
