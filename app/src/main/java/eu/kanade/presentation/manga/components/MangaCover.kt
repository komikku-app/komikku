...
enum class MangaCover(val ratio: Float) {
    ...
    operator fun invoke(
        ...
        onClick: (() -> Unit)? = null,
        // KMK -->
        /** alpha value, which used for selection/favorite state */
        alpha: Float = 1f,
        ...
        Box(
            ...
            // Must put this outside of AsyncImagePainter.State since
            // state won't auto change to succeed on first composition
            Image(
                painter = painter,
