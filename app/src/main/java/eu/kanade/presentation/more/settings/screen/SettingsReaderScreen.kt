...
class SettingsReaderScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            ...
            Preference.PreferenceItem.SwitchPreference(
                ...
                title = stringResource(id = R.string.pref_force_horz_seekbar),
                subtitle = stringResource(id = R.string.pref_force_horz_seekbar_summary),
            ),
            Preference.PreferenceItem.SwitchPreference(
                pref = readerPref.forceHorizontalSeekbar(),
                title = stringResource(id = R.string.pref_show_vert_seekbar_landscape),
                subtitle = stringResource(id = R.string.pref_show_vert_seekbar_landscape_summary),
                enabled = !forceHorizontalSeekbar,
            ),
            Preference.PreferenceItem.SwitchPreference(
                pref = readerPref.forceHorizontalSeekbar(),
                title = stringResource(id = R.string.pref_left_handed_vertical_seekbar),
                subtitle = stringResource(id = R.string.pref_left_handed_vertical_seekbar_summary),
                enabled = !forceHorizontalSeekbar,
            ),
            // SY <--
            Preference.PreferenceItem.SwitchPreference(
        ...
        return Preference.PreferenceGroup(
            ...
            preferenceItems = listOf(
                ...
                Preference.PreferenceItem.SwitchPreference(
                    ...
                    title = stringResource(id = R.string.enable_zoom_out),
                ),
                // SY <--
            ),
        )
    ...
    private fun getContinuousVerticalGroup(readerPreferences: ReaderPreferences): Preference.PreferenceGroup {
        return Preference.PreferenceGroup(
            title = stringResource(id = R.string.vertical_plus_viewer),
            preferenceItems = listOf(
                Preference.PreferenceItem.SwitchPreference(
                    pref = readerPreferences.continuousVerticalTappingByPage(),
                    title = stringResource(id = R.string.tap_scroll_page),
                    subtitle = stringResource(id = R.string.tap_scroll_page_summary),
                ),
                Preference.PreferenceItem.SwitchPreference(
    ...
    private fun getPageDownloadingGroup(readerPreferences: ReaderPreferences): Preference.PreferenceGroup {
        return Preference.PreferenceGroup(
            title = stringResource(id = R.string.page_downloading),
            preferenceItems = listOf(
                Preference.PreferenceItem.ListPreference(
    ...
    private fun getForkSettingsGroup(readerPreferences: ReaderPreferences): Preference.PreferenceGroup {
        ...
        return Preference.PreferenceGroup(
            title = stringResource(id = R.string.pref_category_fork),
            preferenceItems = listOf(
                Preference.PreferenceItem.SwitchPreference(
