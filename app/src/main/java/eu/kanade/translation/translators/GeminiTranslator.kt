...
class GeminiTranslator(private val langFrom: ScanLanguage, private val langTo: Locale, private var apiKey: String) : LanguageTranslator {
    private var model: GenerativeModel = GenerativeModel(
        ...
        systemInstruction = content { text("## System Prompt for Manhwa/Manga/Manhua Translation\n" +
            "\n" +
