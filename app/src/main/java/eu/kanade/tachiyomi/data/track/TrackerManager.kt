...
class TrackerManager {
    ...
    val doujinTracker = DoujinTracker(DOUJIN_TRACKER)

    val trackers =
        listOf(mdList, myAnimeList, aniList, kitsu, shikimori, bangumi, komga, mangaUpdates, kavita, suwayomi, doujinTracker)
