        ...
        when (val dialog = successState.dialog) {
            ...
            is BlockruleDialog.Create -> {
                BlockruleCreateDialog(
                    ...
                    title = tachiyomi.presentation.core.i18n.stringResource(KMR.strings.block_rule_add_block_rule),
                )
            }
            ...
            is BlockruleDialog.Edit -> {
                ...
                BlockruleCreateDialog(
                    ...
                    blockrules = successState.blockrules,
                    editBlockrule = edit,
                    title = tachiyomi.presentation.core.i18n.stringResource(KMR.strings.block_rule_edit_block_rule),
                )
            }
        }
