...
object Group2 : TagList {
    override fun getTags1(): List<String> = listOf(
        ...
        "group:th",
        "group:th4",
        "group:thai doujinshi doukoukai",
