...
class LibraryPreferences(
    ...
    // KMK -->
    fun showReadingProgress() = preferenceStore.getBoolean(
        "library_display_reading_progress",
        false,
    )

    fun showCompletedMark() = preferenceStore.getBoolean(
        "library_display_completed_mark",
        true,
    )
    // KMK <--
